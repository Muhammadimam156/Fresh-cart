      ...
      <div className="mt-5 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <section className="organic-card p-7">
          ...
          <div className="mt-6 grid gap-3 text-sm text-[#4a5847]">
            <div className="rounded-2xl bg-[#f8f4ea] p-4">WhatsApp: 0323-0000000</div>
            <div className="rounded-2xl bg-[#f8f4ea] p-4">Phone: +92 300 0000000</div>
            <div className="rounded-2xl bg-[#f8f4ea] p-4">Email: support@freshkart.pk</div>
            <div className="rounded-2xl bg-[#f8f4ea] p-4">Address: Karachi, Pakistan</div>
          </div>
        </section>
